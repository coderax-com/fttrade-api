"""
Django settings for fttrade project.
...
SECRET_KEY = 'django-insecure-i5epxpiys2kf-o(^ey2!c3*y_l65g8qyrp%g%gt(hlx+rcs^w!'
...
WSGI_APPLICATION = 'fttrade.wsgi.application'
